% Let’s implement code that uses an ETS table to associate phone numbers -
% or more accurately, mobile subscriber integrated services digital network
% (MSISDN) numbers — to Pids in a module called hlr.
